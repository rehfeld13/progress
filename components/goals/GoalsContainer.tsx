...
export default function GoalsContainer() {
  ...
  return (
    <div className="flex flex-col items-start w-full border-x border-b-0 border-gray-800/40">      
      <div className="bg-gray-950/40 p-2 min-h-[150px] w-full gap-4 flex flex-col items-center">
        <button
